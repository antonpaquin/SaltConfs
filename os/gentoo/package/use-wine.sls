{% set use = {
  ...
  'sys-apps/util': 'abi_x86_32',
  'media-libs/lcms': 'abi_x86_32',
  'media-libs/mesa': 'abi_x86_32',
  'dev-libs/libpthread': 'abi_x86_32',
...
package.use/wine/{{ package }}:
  file.append:
    - name: /etc/portage/package.use/wine.use
    - text: {{package}} {{flags}}
    - require:
